...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
        <a class="navbar-brand" href="login.php">Blood Bank Management System</a>
            ...
            <div class="col-md-4 mx-auto" id="login-container">
                ...
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" autocomplete="off" placeholder="Enter email ID" required>
                    </div><br>
                    <div class="form-group">
